...
//     söyleyelim. Eger oncesinde sayfa yuklenirse, beklemeyi bıraksin.
 ...
 //5 - "https://www.otto.de" adresine gidelim
  ...
  // 6 - Bu web adresinin sayfa basligini (title) ve adres (url)ini alalim
        ...
        System.out.println(ottoURL);//https://www.otto.de/
        System.out.println(ottoTitle);//OTTO - Mode, Möbel & Technik » Zum Online-Shop

// 7 - Title ve url'nin "OTTO" kelimesinin icerip icermedigini kontrol edelim
        if(ottoTitle.contains("OTTO")&& ottoURL.contains("OTTO")) System.out.println("Otto yazisi vardir");
