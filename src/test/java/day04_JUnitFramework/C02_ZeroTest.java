...
public class C02_ZeroTest {
    ...
    public void test01(){
        ...
        driver.findElement(By.id("//span[text()=‘Pay Bills’]")).sendKeys("2020-09-10");
        //9. Pay buttonuna tiklayin
        driver.findElement(By.id("pay_saved_payees")).click();
        //10. “The payment was successfully submitted.” mesajinin ciktigini test edin.
        WebElement actualmesajElementi=driver.findElement(By.id("alert_content"));
        if (actualmesajElementi.isDisplayed()) System.out.println("Test Passed");
